...
Requirement.create(sprint_id:6, expected_time:4, actual_time:2, statement:"As a user, I want to send screenshots", status:"Complete")
Requirement.create(sprint_id:6, expected_time:90000000, actual_time:1, statement:"As a user, I want to do everything Facebook can do", status:"Blocked")
Requirement.create(sprint_id:6, expected_time:2, actual_time:1, statement:"As a user, I want to add different features", status:"Not Started")
Requirement.create(sprint_id:6, expected_time:1, actual_time:5, statement:"As a user, I want to remove different features", status:"Pending Client Payment")
Requirement.create(sprint_id:6, expected_time:3, actual_time:6, statement:"As a user, I want to make a rough sketch", status:"In Progress")
Requirement.create(sprint_id:6, expected_time:4, actual_time:2, statement:"As a user, I want to send screenshots", status:"Requirement Complete")
Requirement.create(sprint_id:6, expected_time:90000000, actual_time:1, statement:"As a user, I want to do everything Facebook can do", status:"Approved")
