...
Requirement.create(sprint_id:6, expected_time:1, actual_time:5, statement:"As a user, I want to remove different features", status:"Development In Progress")
Requirement.create(sprint_id:6, expected_time:3, actual_time:6, statement:"As a user, I want to make a rough sketch", status:"Ready to Start")
